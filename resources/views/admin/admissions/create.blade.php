            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('construction') ? 'is-invalid' : '' }}" name="construction_id" id="construction_id" required>
                            @foreach($constructions as $id => $entry)
                                <option value="{{ $id }}" {{ (old('construction_id') ? old('construction_id') : ''->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('partner') ? 'is-invalid' : '' }}" name="partner_id" id="partner_id" required>
                            @foreach($partners as $id => $entry)
                                <option value="{{ $id }}" {{ (old('partner_id') ? old('partner_id') : ''->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('occupation') ? 'is-invalid' : '' }}" name="occupation_id" id="occupation_id" required>
                            @foreach($occupations as $id => $entry)
                                <option value="{{ $id }}" {{ (old('occupation_id') ? old('occupation_id') : ''->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('salary') ? 'is-invalid' : '' }}" name="salary_id" id="salary_id" required>
                            @foreach($salaries as $id => $entry)
                                <option value="{{ $id }}" {{ (old('salary_id') ? old('salary_id') : ''->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="sp_celphones form-control {{ $errors->has('phone_contact') ? 'is-invalid' : '' }}" type="text" name="phone_contact" id="phone_contact" value="{{ old('phone_contact', '') }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="sp_celphones form-control {{ $errors->has('phone_message') ? 'is-invalid' : '' }}" type="text" name="phone_message" id="phone_message" value="{{ old('phone_message', '') }}">
            ...
            <div class="row div_spouse">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="cpf form-control {{ $errors->has('spouse_cpf') ? 'is-invalid' : '' }}" type="text" name="spouse_cpf" id="spouse_cpf" value="{{ old('spouse_cpf', '') }}">
