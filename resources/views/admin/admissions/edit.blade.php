    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.admissions.update", [$admission->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_contact') ? 'is-invalid' : '' }}" type="text" name="phone_contact" id="phone_contact" value="{{ old('phone_contact', $admission->phone_contact) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_message') ? 'is-invalid' : '' }}" type="text" name="phone_message" id="phone_message" value="{{ old('phone_message', $admission->phone_message) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spouse_cpf') ? 'is-invalid' : '' }}" type="text" name="spouse_cpf" id="spouse_cpf" value="{{ old('spouse_cpf', $admission->spouse_cpf) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_declaration') ? 'is-invalid' : '' }}" type="text" name="date_declaration" id="date_declaration" value="{{ old('date_declaration', $admission->date_declaration) }}">
