            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="money form-control {{ $errors->has('salary') ? 'is-invalid' : '' }}" type="text" name="salary" id="salary" value="{{ old('salary', $hiring->salary) }}"  required>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="money form-control {{ $errors->has('health_plan') ? 'is-invalid' : '' }}" type="text" name="health_plan" id="health_plan" value="{{ old('health_plan', $hiring->health_plan) }}" >
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="money form-control {{ $errors->has('vehicle_rental') ? 'is-invalid' : '' }}" type="text" name="vehicle_rental" id="vehicle_rental" value="{{ old('vehicle_rental', $hiring->vehicle_rental) }}" >
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="money form-control {{ $errors->has('laptop_rental') ? 'is-invalid' : '' }}" type="text" name="laptop_rental" id="laptop_rental" value="{{ old('laptop_rental', $hiring->laptop_rental) }}" >
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="money form-control {{ $errors->has('phone_plan') ? 'is-invalid' : '' }}" type="text" name="phone_plan" id="phone_plan" value="{{ old('phone_plan', $hiring->phone_plan) }}" >
