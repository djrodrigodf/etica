    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.hirings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('health_plan') ? 'is-invalid' : '' }}" type="number" name="health_plan" id="health_plan" value="{{ old('health_plan', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('vehicle_rental') ? 'is-invalid' : '' }}" type="number" name="vehicle_rental" id="vehicle_rental" value="{{ old('vehicle_rental', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('laptop_rental') ? 'is-invalid' : '' }}" type="number" name="laptop_rental" id="laptop_rental" value="{{ old('laptop_rental', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone_plan') ? 'is-invalid' : '' }}" type="number" name="phone_plan" id="phone_plan" value="{{ old('phone_plan', '') }}" step="0.01">
