    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.constructions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('iss') ? 'is-invalid' : '' }}" type="number" name="iss" id="iss" value="{{ old('iss', '') }}" step="0.01">
                @if($errors->has('iss'))
                    <div class="invalid-feedback">
                        {{ $errors->first('iss') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('partner_percentage') ? 'is-invalid' : '' }}" type="number" name="partner_percentage" id="partner_percentage" value="{{ old('partner_percentage', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('administration_fee') ? 'is-invalid' : '' }}" type="number" name="administration_fee" id="administration_fee" value="{{ old('administration_fee', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reserve_fund') ? 'is-invalid' : '' }}" type="number" name="reserve_fund" id="reserve_fund" value="{{ old('reserve_fund', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('average_discount') ? 'is-invalid' : '' }}" type="number" name="average_discount" id="average_discount" value="{{ old('average_discount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contract_value') ? 'is-invalid' : '' }}" type="number" name="contract_value" id="contract_value" value="{{ old('contract_value', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cnpj_branch') ? 'is-invalid' : '' }}" type="text" name="cnpj_branch" id="cnpj_branch" value="{{ old('cnpj_branch', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('policy_value') ? 'is-invalid' : '' }}" type="number" name="policy_value" id="policy_value" value="{{ old('policy_value', '') }}" step="0.01">
