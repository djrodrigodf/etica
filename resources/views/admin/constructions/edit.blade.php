            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="percent form-control {{ $errors->has('iss') ? 'is-invalid' : '' }}" type="text" name="iss" id="iss" value="{{ old('iss', $construction->iss) }}">
                        @if($errors->has('iss'))
                            <div class="invalid-feedback">
                                {{ $errors->first('iss') }}
                            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="percent form-control {{ $errors->has('tax') ? 'is-invalid' : '' }}" type="text" name="tax" id="tax" value="{{ old('tax', $construction->tax) }}" >
                        @if($errors->has('tax'))
                            <div class="invalid-feedback">
                                {{ $errors->first('tax') }}
                            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="percent form-control {{ $errors->has('partner_percentage') ? 'is-invalid' : '' }}" type="text" name="partner_percentage" id="partner_percentage" value="{{ old('partner_percentage', $construction->partner_percentage) }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="percent form-control {{ $errors->has('administration_fee') ? 'is-invalid' : '' }}" type="text" name="administration_fee" id="administration_fee" value="{{ old('administration_fee', $construction->administration_fee) }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="money form-control {{ $errors->has('reserve_fund') ? 'is-invalid' : '' }}" type="text" name="reserve_fund" id="reserve_fund" value="{{ old('reserve_fund', $construction->reserve_fund) }}">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="percent form-control {{ $errors->has('average_discount') ? 'is-invalid' : '' }}" type="text" name="average_discount" id="average_discount" value="{{ old('average_discount', $construction->average_discount) }}">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="money form-control {{ $errors->has('contract_value') ? 'is-invalid' : '' }}" type="text" name="contract_value" id="contract_value" value="{{ old('contract_value', $construction->contract_value) }}">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="cnpj form-control {{ $errors->has('cnpj_branch') ? 'is-invalid' : '' }}" type="text" name="cnpj_branch" id="cnpj_branch" value="{{ old('cnpj_branch', $construction->cnpj_branch) }}">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <input class="money form-control {{ $errors->has('policy_value') ? 'is-invalid' : '' }}" type="text" name="policy_value" id="policy_value" value="{{ old('policy_value', $construction->policy_value) }}">
