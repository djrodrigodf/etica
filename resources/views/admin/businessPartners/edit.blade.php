            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="cpfOuCnpj form-control {{ $errors->has('cnpj_cpf') ? 'is-invalid' : '' }}" type="text" name="cnpj_cpf" id="cpfcnpj" value="{{ old('cnpj_cpf', $businessPartner->cnpj_cpf) }}" required>
                ...
                <div class="col-md-6 pj">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('ie') ? 'is-invalid' : '' }}" type="text" name="ie" id="ie" value="{{ old('ie', $businessPartner->ie) }}">
                        @if($errors->has('ie'))
                            <div class="invalid-feedback">
                                {{ $errors->first('ie') }}
                            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $businessPartner->name) }}" required>
                        @if($errors->has('name'))
                            <div class="invalid-feedback">
                                {{ $errors->first('name') }}
                            </div>
                ...
                <div class="col-md-6 pj">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" type="text" name="company_name" id="company_name" value="{{ old('company_name', $businessPartner->company_name) }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="sp_celphones form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $businessPartner->phone) }}" required>
                        @if($errors->has('phone'))
                            <div class="invalid-feedback">
                                {{ $errors->first('phone') }}
                            </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $businessPartner->email) }}" required>
                        @if($errors->has('email'))
                            <div class="invalid-feedback">
                                {{ $errors->first('email') }}
                            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input onblur="pesquisacep(this.value);" class="cep form-control {{ $errors->has('zip_code') ? 'is-invalid' : '' }}" type="text" name="zip_code" id="zip_code" value="{{ old('zip_code', $businessPartner->zip_code) }}" required>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $businessPartner->address) }}" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('number') ? 'is-invalid' : '' }}" type="text" name="number" id="number" value="{{ old('number', $businessPartner->number) }}" required>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('complement') ? 'is-invalid' : '' }}" type="text" name="complement" id="complement" value="{{ old('complement', $businessPartner->complement) }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('district') ? 'is-invalid' : '' }}" type="text" name="district" id="district" value="{{ old('district', $businessPartner->district) }}" required>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $businessPartner->city) }}" required>
                        @if($errors->has('city'))
                            <div class="invalid-feedback">
                                {{ $errors->first('city') }}
                            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('state') ? 'is-invalid' : '' }}" type="text" name="state" id="state" value="{{ old('state', $businessPartner->state) }}" required>
                        @if($errors->has('state'))
                            <div class="invalid-feedback">
                                {{ $errors->first('state') }}
                            </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $businessPartner->country) }}">
