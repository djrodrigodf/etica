    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.business-partners.update", [$businessPartner->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cnpj_cpf') ? 'is-invalid' : '' }}" type="text" name="cnpj_cpf" id="cnpj_cpf" value="{{ old('cnpj_cpf', $businessPartner->cnpj_cpf) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ie') ? 'is-invalid' : '' }}" type="text" name="ie" id="ie" value="{{ old('ie', $businessPartner->ie) }}" required>
                @if($errors->has('ie'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ie') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $businessPartner->phone) }}" required>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zip_code') ? 'is-invalid' : '' }}" type="text" name="zip_code" id="zip_code" value="{{ old('zip_code', $businessPartner->zip_code) }}" required>
